...
export const loginUser = async (request, response) => {
    ...
    try {
        ...
        const refreshToken = jwt.sign(tokenPayload, JWT_REFRESH_SECRET, refreshSignOptions);
...
export const logoutUser = async (request, response) => {
    ...
    response.status(400).json({
        message: "Refresh token or Authorization Bearer header is required to log out",
    });
};
